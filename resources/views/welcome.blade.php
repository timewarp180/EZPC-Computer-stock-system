...
<head>
    ...
    <link rel='shortcut icon' type='image/x-icon' href='{{asset('backEnd')}}/assets/img/EZPCICON.jpg' />
    <style>
        .hover a:hover{
        ...
        <div class="main-sidebar sidebar-style-2" v-show="$route.path === '/' || $route.path === '/register' ? false : true " style="display: none" id="sidebar">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <router-link :to="{name: 'home'}"> <img alt="image" src="{{asset('backEnd')}}/assets/img/EZPCICON.jpg" class="header-logo" /> <span
                            class="logo-name">EZPC</span>
                    </router-link>
                </div>
                <ul class="sidebar-menu">
                    <li class="menu-header">Main</li>
                    <li class="dropdown active">
                        <router-link :to="{name: 'home'}" class="nav-link"><i class="fas fa-desktop"></i><span>Dashboard</span></router-link>
                    </li>

                    <li class="hover" style="background-color:#83bceb">
                        <router-link :to="{name: 'pointofsell'}" class="nav-link text-white"><i class="fas fa-shopping-cart"></i><span>Sell</span></router-link>
                    </li>

                    <li class="dropdown">
                        <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                 class="fas fa-briefcase"></i><span>Orders</span></a>
                    ...
                    <li class="dropdown">
                     ...
                     <li class="dropdown">
                        <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                 class="fab fa-buffer"></i><span>Categories</span></a>
                        <ul class="dropdown-menu">
                   ...
                   <li class="dropdown">
                        <router-link :to="{name:'stock'}"><i
                                class="fas fa-cubes"></i><span>Stock</span></router-link>
                    ...
                    <li class="dropdown">
                        <a href="#" class="menu-toggle nav-link has-dropdown"><i class="fas fa-user-alt"></i><span>Account</span></a>
                        <ul class="dropdown-menu">
